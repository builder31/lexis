...
# The following items will require adding fields to the wordpress user object
#	,"My Language" => "/app/oneword/myLanguage/"
	...
	# is App_User still required? The wordpress user object will be referenced directly and only a singular user directory will be authoritative. There should be no duplicate entry.
